...
class SignUpPage extends Component {
    ...
    async getData() {
        await axios.get('https://craftslane.com/index.php?route=api/customcountry/index&key=&os_type=android').then((resp) => this.setState({ countries: resp.data.body }));
    ...
    async selectCountry(idx) {
        ...
        await axios.get('https://craftslane.com/index.php?route=api/customzone/index&key=&os_type=android&country_id=' + idx.country_id).then((resp) => this.setState({ zones: resp.data.body }));
